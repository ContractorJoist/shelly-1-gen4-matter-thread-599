...
```bash
git clone https://github.com/ContractorJoist/shelly-1-gen4-matter-thread-599.git
cd shelly-1-gen4-matter-thread-599
...
Have a firmware variant or feature you'd like to see prioritized? [Vote on the roadmap discussion](https://github.com/ContractorJoist/shelly-1-gen4-matter-thread-599/discussions) or open an issue with your use case.
...
<!-- Last updated: 2026-06-06 20:00:37 -->
